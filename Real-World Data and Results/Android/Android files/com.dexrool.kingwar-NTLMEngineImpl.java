...
public final class NTLMEngineImpl implements NTLMEngine {
    ...
    final String getResponseFor(String str, String str2, String str3, String str4, String str5) throws NTLMEngineException {
        ...
        if (str == null || str.trim().equals("")) {
            str6 = getType1Message(str4, str5);
        } else {
            Type2Message type2Message = new Type2Message(str);
            str6 = getType3Message(str2, str3, str4, str5, type2Message.getChallenge(), type2Message.getFlags(), type2Message.getTarget(), type2Message.getTargetInfo());
        }
        return str6;
    }
    ...
    public static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i, String str5, byte[] bArr2) throws NTLMEngineException {
            ...
            try {
                if ((i & NTLMEngineImpl.FLAG_TARGETINFO_PRESENT) != 0 && bArr2 != null && str5 != null) {
                ...
                } else if ((i & NTLMEngineImpl.FLAG_REQUEST_NTLM2_SESSION) != 0) {
            ...
            if (convertHost != null) {
                try {
                    bArr3 = convertHost.getBytes("UnicodeLittleUnmarked");
    ...
    public static class MD4 {
        ...
        byte[] getOutput() {
            ...
            for (int i3 = 0; i3 < 8; i3++) {
                bArr[i + i3] = (byte) ((int) ((this.count * 8) >>> (8 * i3)));
            }
            update(bArr);
            byte[] bArr2 = new byte[16];
