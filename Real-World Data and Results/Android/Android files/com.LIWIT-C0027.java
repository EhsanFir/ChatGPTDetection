...
public final class C0027 {
    ...
    public static String m603MD5(byte[] bytes) {
    ...
    public static String m599RC4(String data, String key) {
    ...
    public static String m601RC4(String data, String key) {
        if (data == null || key == null) {
            return "";
        }
        try {
    ...
    public static byte[] m600RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static byte[] m602RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static String m597DES(String encryptString, String encryptKey) throws Exception {
        try {
            ...
            return m595BASE64(cipher.doFinal(encryptString.getBytes("GBK")));
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String m598DES(String decryptString, String decryptKey) throws Exception {
        try {
            byte[] byteMi = m596BASE64(decryptString);
            IvParameterSpec zeroIv = new IvParameterSpec(new byte[]{1, 2, 3, 4, 5, 6, 7, 8});
    ...
    public static String m595BASE64(byte[] data) {
        try {
    ...
    public static byte[] m596BASE64(String data) {
        try {
    ...
    public static String m593Authcode(String source, String key) {
        try {
    ...
    public static String m594Authcode(String source, String key) {
        try {
