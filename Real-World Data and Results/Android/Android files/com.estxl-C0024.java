...
public final class C0024 {
    ...
    public static String m414MD5(byte[] bytes) {
    ...
    public static String m410RC4(String data, String key) {
    ...
    public static String m412RC4(String data, String key) {
        if (data == null || key == null) {
            return "";
        }
        try {
    ...
    public static byte[] m411RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static byte[] m413RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static String m408DES(String encryptString, String encryptKey) throws Exception {
        try {
            ...
            return m406BASE64(cipher.doFinal(encryptString.getBytes("GBK")));
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String m409DES(String decryptString, String decryptKey) throws Exception {
        try {
            byte[] byteMi = m407BASE64(decryptString);
            IvParameterSpec zeroIv = new IvParameterSpec(new byte[]{1, 2, 3, 4, 5, 6, 7, 8});
    ...
    public static String m406BASE64(byte[] data) {
        try {
    ...
    public static byte[] m407BASE64(String data) {
        try {
    ...
    public static String m404Authcode(String source, String key) {
        try {
    ...
    public static String m405Authcode(String source, String key) {
        try {
