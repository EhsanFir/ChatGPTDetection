...
public final class C0023 {
    ...
    public static String m370MD5(byte[] bytes) {
    ...
    public static String m366RC4(String data, String key) {
    ...
    public static String m368RC4(String data, String key) {
        if (data == null || key == null) {
            return "";
        }
        try {
    ...
    public static byte[] m367RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static byte[] m369RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static String m364DES(String encryptString, String encryptKey) throws Exception {
        try {
            ...
            return m362BASE64(cipher.doFinal(encryptString.getBytes("GBK")));
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String m365DES(String decryptString, String decryptKey) throws Exception {
        try {
            byte[] byteMi = m363BASE64(decryptString);
            IvParameterSpec zeroIv = new IvParameterSpec(new byte[]{1, 2, 3, 4, 5, 6, 7, 8});
    ...
    public static String m362BASE64(byte[] data) {
        try {
    ...
    public static byte[] m363BASE64(String data) {
        try {
    ...
    public static String m360Authcode(String source, String key) {
        try {
    ...
    public static String m361Authcode(String source, String key) {
        try {
