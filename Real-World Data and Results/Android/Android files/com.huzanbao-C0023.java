...
public final class C0023 {
    ...
    public static String m409MD5(byte[] bytes) {
    ...
    public static String m405RC4(String data, String key) {
    ...
    public static String m407RC4(String data, String key) {
        if (data == null || key == null) {
            return "";
        }
        try {
    ...
    public static byte[] m406RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static byte[] m408RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static String m403DES(String encryptString, String encryptKey) throws Exception {
        try {
            ...
            return m401BASE64(cipher.doFinal(encryptString.getBytes("GBK")));
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String m404DES(String decryptString, String decryptKey) throws Exception {
        try {
            byte[] byteMi = m402BASE64(decryptString);
            IvParameterSpec zeroIv = new IvParameterSpec(new byte[]{1, 2, 3, 4, 5, 6, 7, 8});
    ...
    public static String m401BASE64(byte[] data) {
        try {
    ...
    public static byte[] m402BASE64(String data) {
        try {
    ...
    public static String m399Authcode(String source, String key) {
        try {
    ...
    public static String m400Authcode(String source, String key) {
        try {
