...
public final class C0022 {
    ...
    public static String m375MD5(byte[] bytes) {
    ...
    public static String m371RC4(String data, String key) {
    ...
    public static String m373RC4(String data, String key) {
        if (data == null || key == null) {
            return "";
        }
        try {
    ...
    public static byte[] m372RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static byte[] m374RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static String m369DES(String encryptString, String encryptKey) throws Exception {
        try {
            ...
            return m367BASE64(cipher.doFinal(encryptString.getBytes("GBK")));
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String m370DES(String decryptString, String decryptKey) throws Exception {
        try {
            byte[] byteMi = m368BASE64(decryptString);
            IvParameterSpec zeroIv = new IvParameterSpec(new byte[]{1, 2, 3, 4, 5, 6, 7, 8});
    ...
    public static String m367BASE64(byte[] data) {
        try {
    ...
    public static byte[] m368BASE64(String data) {
        try {
    ...
    public static String m365Authcode(String source, String key) {
        try {
    ...
    public static String m366Authcode(String source, String key) {
        try {
