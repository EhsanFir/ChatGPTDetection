...
public final class C0023 {
    ...
    public static String m393MD5(byte[] bytes) {
    ...
    public static String m389RC4(String data, String key) {
    ...
    public static String m391RC4(String data, String key) {
        if (data == null || key == null) {
            return "";
        }
        try {
    ...
    public static byte[] m390RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static byte[] m392RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static String m387DES(String encryptString, String encryptKey) throws Exception {
        try {
            ...
            return m385BASE64(cipher.doFinal(encryptString.getBytes("GBK")));
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String m388DES(String decryptString, String decryptKey) throws Exception {
        try {
            byte[] byteMi = m386BASE64(decryptString);
            IvParameterSpec zeroIv = new IvParameterSpec(new byte[]{1, 2, 3, 4, 5, 6, 7, 8});
    ...
    public static String m385BASE64(byte[] data) {
        try {
    ...
    public static byte[] m386BASE64(String data) {
        try {
    ...
    public static String m383Authcode(String source, String key) {
        try {
