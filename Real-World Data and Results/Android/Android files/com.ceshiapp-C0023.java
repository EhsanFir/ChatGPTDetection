...
public final class C0023 {
    ...
    public static String m343MD5(byte[] bytes) {
    ...
    public static String m339RC4(String data, String key) {
    ...
    public static String m341RC4(String data, String key) {
        if (data == null || key == null) {
            return "";
        }
        try {
    ...
    public static byte[] m340RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static byte[] m342RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static String m337DES(String encryptString, String encryptKey) throws Exception {
        try {
            ...
            return m335BASE64(cipher.doFinal(encryptString.getBytes("GBK")));
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String m338DES(String decryptString, String decryptKey) throws Exception {
        try {
            byte[] byteMi = m336BASE64(decryptString);
            IvParameterSpec zeroIv = new IvParameterSpec(new byte[]{1, 2, 3, 4, 5, 6, 7, 8});
    ...
    public static String m335BASE64(byte[] data) {
        try {
    ...
    public static byte[] m336BASE64(String data) {
        try {
    ...
    public static String m333Authcode(String source, String key) {
        try {
    ...
    public static String m334Authcode(String source, String key) {
        try {
