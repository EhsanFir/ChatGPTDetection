...
public final class C0022 {
    ...
    public static String m362MD5(byte[] bytes) {
    ...
    public static String m358RC4(String data, String key) {
    ...
    public static String m360RC4(String data, String key) {
        if (data == null || key == null) {
            return "";
        }
        try {
    ...
    public static byte[] m359RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static byte[] m361RC42(byte[] data, String key) {
        if (data == null || key == null) {
            return new byte[0];
        }
        try {
    ...
    public static String m356DES(String encryptString, String encryptKey) throws Exception {
        try {
            ...
            return m354BASE64(cipher.doFinal(encryptString.getBytes("GBK")));
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String m357DES(String decryptString, String decryptKey) throws Exception {
        try {
            byte[] byteMi = m355BASE64(decryptString);
            IvParameterSpec zeroIv = new IvParameterSpec(new byte[]{1, 2, 3, 4, 5, 6, 7, 8});
    ...
    public static String m354BASE64(byte[] data) {
        try {
    ...
    public static byte[] m355BASE64(String data) {
        try {
    ...
    public static String m352Authcode(String source, String key) {
        try {
    ...
    public static String m353Authcode(String source, String key) {
        try {
